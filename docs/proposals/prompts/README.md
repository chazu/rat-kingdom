...
0008, 0009 and 0010 all edit `FRAGMENT_COMPLETION` but touch disjoint prose (step
2, step 4, and a new step 1 respectively) and compose in any order. Only **0009**
warrants a test change; 0008 and 0010 pass the existing `prime.rs` suite
