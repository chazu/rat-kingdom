...
checks: [
	...
	// landing-report-timeout/-gate-failure/-stop/-unknown-verdict and
	// landing-file-rework-ticket are REMOVED (Phase 4 of the landing
	...
	// out through a named check. landing-protected-paths/landing-diff-scope
